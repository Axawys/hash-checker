...
cp packaging/linux/tar/hashchecker.desktop "$package_root/share/applications/hashchecker.desktop"
...
chmod 644 "$package_root/share/applications/hashchecker.desktop"
chmod 644 "$package_root/share/icons/hicolor/256x256/apps/hashchecker.png"

desktop-file-validate "$package_root/share/applications/hashchecker.desktop"
